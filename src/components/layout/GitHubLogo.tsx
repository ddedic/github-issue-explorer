    ...
    <svg
      ...
      <defs>
        ...
        <clipPath id="prefix__clip0">
          <path fill="#fff" d="M0-40h688v688H0z" />
        </clipPath>
      </defs>
    </svg>
  );
